...
class HODMainPage extends StatefulWidget {
  @override
  _HODMainPageState createState() => _HODMainPageState();
}

class _HODMainPageState extends State<HODMainPage> {
            ...
            if(!snapshot.hasData){
              ...
              return ListView.builder(
                ...
                itemBuilder: (context,index){
                  ...
                  if(validArray[0] == 0 && validArray[1] == 0 && validArray[2] == 0)
                  {
